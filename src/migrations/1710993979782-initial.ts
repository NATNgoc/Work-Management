...
export class Initial1710993979782 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."workspace_members_role_enum" AS ENUM('owner', 'leader', 'member')`);
        await queryRunner.query(`CREATE TABLE "workspace_members" ("workspace_id" uuid NOT NULL, "user_id" uuid NOT NULL, "role" "public"."workspace_members_role_enum" NOT NULL DEFAULT 'member', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_4896b609c71ca5ad20ad662077b" PRIMARY KEY ("workspace_id", "user_id"))`);
        await queryRunner.query(`CREATE TYPE "public"."workspaces_type_enum" AS ENUM('personal', 'teamwork')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."task_status_enum" AS ENUM('accepted', 'pending', 'rejected')`);
        ...
        await queryRunner.query(`CREATE TABLE "sessions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "expiredAt" TIMESTAMP NOT NULL, "userId" uuid, CONSTRAINT "PK_3238ef96f18b355b671619111bc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "system_parameters" ("id" character varying NOT NULL, "description" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "value" jsonb NOT NULL, CONSTRAINT "PK_aa5092b6c74cc30dfcd959ce14a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."workspace_invitations_status_enum" AS ENUM('accepted', 'pending', 'rejected')`);
        await queryRunner.query(`CREATE TABLE "workspace_invitations" ("workspace_id" uuid NOT NULL, "inviting_user_id" uuid NOT NULL, "invited_user_id" uuid NOT NULL, "status" "public"."workspace_invitations_status_enum" NOT NULL DEFAULT 'pending', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_32d5b4131ceafee5f8c2f1e8039" PRIMARY KEY ("workspace_id", "inviting_user_id", "invited_user_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_4a49d67b2dc62b675e3dfb25296" FOREIGN KEY ("workspace_id") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_7126a406a07736826b7988ae207" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_assignments" ADD CONSTRAINT "FK_b389f4488d0a8241c3c98273966" FOREIGN KEY ("task_id") REFERENCES "task"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_assignments" ADD CONSTRAINT "FK_e5d5edd841944af23344b36b70a" FOREIGN KEY ("userId_assigned_to") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_assignments" ADD CONSTRAINT "FK_299a4972c7d711da41557f0a8d2" FOREIGN KEY ("userId_assigned_by") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "workspace_invitations" ADD CONSTRAINT "FK_b57635adb8131108970d70eeaf6" FOREIGN KEY ("inviting_user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "workspace_invitations" ADD CONSTRAINT "FK_fcdda3808100eeb7245ebc47bfd" FOREIGN KEY ("invited_user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "workspace_invitations" DROP CONSTRAINT "FK_fcdda3808100eeb7245ebc47bfd"`);
        await queryRunner.query(`ALTER TABLE "workspace_invitations" DROP CONSTRAINT "FK_b57635adb8131108970d70eeaf6"`);
        ...
        await queryRunner.query(`ALTER TABLE "task_assignments" DROP CONSTRAINT "FK_299a4972c7d711da41557f0a8d2"`);
        await queryRunner.query(`ALTER TABLE "task_assignments" DROP CONSTRAINT "FK_e5d5edd841944af23344b36b70a"`);
        await queryRunner.query(`ALTER TABLE "task_assignments" DROP CONSTRAINT "FK_b389f4488d0a8241c3c98273966"`);
        await queryRunner.query(`ALTER TABLE "task" DROP CONSTRAINT "FK_7126a406a07736826b7988ae207"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."workspace_invitations_status_enum"`);
